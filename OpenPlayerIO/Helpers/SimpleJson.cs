 ...
 IDictionary<string, object>
{
    ...
    /// comparing keys, or null to use the default <see
...
/// JsonArray(IList&lt;object&gt;) and JsonObject(IDictionary&lt;string,object&gt;). All numbers are
/// parsed to doubles.
/// </summary>
[GeneratedCode("simple-json", "1.0.0")]
...
public static class SimpleJson
{
    ...
    /// <returns>
    /// An IList&lt;object&gt;, a IDictionary&lt;string,object&gt;, a double, a string, null, true,
    /// or false
    /// </returns>
    ...
    private static bool SerializeString(string aString, StringBuilder builder)
    {
        ...
        for (int i = 0; i < charArray.Length; i++) {
            ...
            // Non ascii characters are fine, buffer them up and send them to the builder in larger
            // chunks if possible. The escape table is a 1:1 translation table with \0
